...
static const char *fonts[]          = { "monospace:size=14", "JoyPixels:size=14:antialias=true:autohint=true", "Symbols Nerd Font:size=16:style=bold:antialias=true:autohint=true" };
...
static const char *colors[][3]      = {
  ...
  [SchemeSel]  = { seltagfgcolor, normbgcolor, selbordercolor  },
...
static const Rule rules[] = {
  ...
  { "control.exe",    NULL,       NULL,                      1 << 4,       1,           1,           -1 },
  { NULL,             NULL,       "Downloading file",        1 << 4,       1,           1,           -1 },
  { NULL,             NULL,       "Wine Mono Installer",     1 << 4,       1,           1,           -1 },
  { NULL,             NULL,       "Battle.net Setup",        1 << 4,       1,           1,           -1 },
...
/*static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", titlefg, NULL }; */
