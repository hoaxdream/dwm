...
static const char *fonts[]          = { "monospace:size=16", "JoyPixels:size=16:antialias=true:autohint=true", "Symbols Nerd Font:size=18:style=bold:antialias=true:autohint=true" };
