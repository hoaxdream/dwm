...
static const char *fonts[]          = { "monospace:size=12", "JoyPixels:size=12:antialias=true:autohint=true", "Symbols Nerd Font:size=16:style=bold:antialias=true:autohint=true" };
