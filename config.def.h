...
static const char *fonts[]          = { "monospace:size=12", "JoyPixels:size=12:antialias=true:autohint=true", "Symbols Nerd Font:size=12:style=bold:antialias=true:autohint=true" };
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_d,      spawn,          SHCMD("launch") },
