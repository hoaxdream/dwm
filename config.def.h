...
static const char *fonts[]          = { "monospace:size=14", "JoyPixels:size=14:antialias=true:autohint=true", "Symbols Nerd Font:size=17:style=bold:antialias=true:autohint=true" };
