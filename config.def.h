...
static const char *fonts[]          = { "monospace:size=15", "JoyPixels:size=15:antialias=true:autohint=true", "Symbols Nerd Font:size=16:style=bold:antialias=true:autohint=true" };
